...
final class Core
{
    ...
    function init_plugin_data()
    {
        ...
        $themes = ['brisk','affirm','landio','level-wp','convertio','rise','framey','vault',
        'lumi', 'finflow','pagebolt', 'nubi', 'outgrid', 'upshift'];
    ...
    public function includes()
    {
        ...
        if (class_exists('\Elementor\Plugin')) {
           ...
           if($this->is_theme && (Helper::get_option('disable_tb') === 'false') ){
                ...
                if($this->is_request('rest')){
                    require UICORE_INCLUDES . '/elementor/theme-builder/class-rest-api.php';
                }
            }
    ...
    public function include_modules()
    {
        ...
        if (file_exists(UICORE_PATH . '/modules/uicore-animate/plugin.php') && !class_exists('UiCoreAnimate\Base')){
            require UICORE_PATH . '/modules/uicore-animate/plugin.php'; //UiCore Animate
        }
    }
