        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .woocommerce-product-gallery .flex-control-thumbs' => 'gap: {{SIZE}}{{UNIT}};',
                        '{{WRAPPER}} .woocommerce-product-gallery .flex-viewport ' => 'margin-bottom: {{SIZE}}{{UNIT}};',
                        '{{WRAPPER}} .woocommerce-product-gallery .flex-control-thumbs li' => 'width: calc((100% - {{SIZE}}{{UNIT}} * 3) / 4) !important;',
                    ],
                    'condition' => [
                        'gallery_style' => ['', 'left_thumbs']
                    ],
