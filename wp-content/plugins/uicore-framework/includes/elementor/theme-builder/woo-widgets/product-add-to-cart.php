...
class Product_Add_To_Cart extends TB_Widget_Base {
    ...
    public function get_scripts()
    {
        ...
        // Scripts required for the add to cart to work on editor - not working
        if($this->is_edit_mode()){
            //Helper::register_widget_script('add-to-cart-editor', ['uicore-manifest']);
            // $scripts[] = 'wp-util';
            // $scripts[] = 'underscore';
            //$scripts[] = 'add-to-cart-editor';
            // $scripts[] = 'wc-add-to-cart-variation';
	...
	private function is_loop_item() {
		//return 'loop-item' === Plugin::elementor()->documents->get_current()->get_type(); Elementor Pro method
        return \is_shop(); // TODO: needs testing
	}
