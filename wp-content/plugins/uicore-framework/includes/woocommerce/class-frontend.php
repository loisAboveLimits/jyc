        ...
        add_action('wp', function () {
            ...
            if(self::is_woo()){
                ...
                if(\is_product()){
                    ...
                    //Check if we need to replace the template with our
                    //theme builder action and block the product default template
                    $this->theme_builder_template();
   ...
   /**
    ...
    function handle_grid_add_to_cart_style() {
        ...
        switch($style){
            ...
            default:
            //add 'alt' class to button
            add_filter('woocommerce_loop_add_to_cart_link', function($button){
                return str_replace('button', 'button alt', $button);
            });
                break;
