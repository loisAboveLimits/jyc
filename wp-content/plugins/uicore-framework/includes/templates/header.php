...
class Header
{
    ...
    public function header()
    {
        ...
        <div data-uils="header" data-uils-title="Header" id="wrapper-navbar" itemscope itemtype="http://schema.org/WebSite" class="uicore uicore-navbar elementor-section<?php //Classic menu
            echo ' ';
            //Classic menu
    ...
    public function get_logo($mode=null)
    {
        ...
        if($mode === 'pill'){
            return '<div class="uicore-logo-pill uicore-only-desktop"><a href="'.home_url('/').'"><img src="'.$main_logo.'" alt="'.get_bloginfo('name').'"></a></div>';
        }
    ...
    function get_branding()
    {
        ...
        ?>
		 <div class="uicore-branding <?php echo Helper::get_option('header_pill') === 'logo-menu' ? 'uicore-only-mobile' : '' ?>" data-uils="header-branding" data-uils-title="Site Logo">
                <?php
                ob_start();
                $this->get_logo();
                $output = ob_get_clean();
