...
var _vueColor = __webpack_require__(69);

var _vueMultiselect = __webpack_require__(3);
...
var _uicoreMiniToggle = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_color_vue__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_570e8ece_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_color_vue__ = __webpack_require__(65);
var disposed = false
...
exports.default = {
    ...
    data: function data() {
        return {
            ...
            productinfoDisplayList: ['popup', 'tab', 'shortcode'],
            productPopupList: ['before short description', 'before add to cart', 'after add to cart', 'after meta'],
            ...
            blockHookList: [{ name: 'Custom (Shortcode)', value: 'custom' }, { name: 'Before Header', value: 'uicore__before_header' }, { name: 'Header Extras', value: 'uicore__header_extras' }, { name: 'Mobile Header', value: 'uicore__mobile_header' }, { name: 'Mobile Menu', value: 'uicore__mobile_menu' }, { name: 'After Header', value: 'uicore__after_header' }, { name: 'Before Content', value: 'uicore__before_content' }, { name: 'After Content', value: 'uicore__after_content' }, { name: 'Before Footer', value: 'uicore__before_footer' }, { name: 'After Footer', value: 'uicore__after_footer' }, { name: 'Before Portfolio Archive', value: 'uicore__before_portfolio_archive' }, { name: 'After Portfolio Archive', value: 'uicore__after_portfolio_archive' }, { name: 'Before Portfolio Single', value: 'uicore__before_portfolio_single' }, { name: 'After Portfolio Single', value: 'uicore__after_portfolio_single' }, { name: 'Before Blog Archive', value: 'uicore__before_blog_archive' }, { name: 'After Blog Archive', value: 'uicore__after_blog_archive' }, { name: 'Before Blog Single', value: 'uicore__before_blog_single' }, { name: 'After Blog Single Content', value: 'uicore__after_blog_single_content' }, { name: 'Before Blog Comments', value: 'uicore__before_blog_comments' }, { name: 'After Blog Single', value: 'uicore__after_blog_single' }],
            isError: false,
            errorMsg: null,
            ...
            productinfoSettings: {
                ...
                label: 'Size Guide',
                order: '25',
                popupTrigger: 'after add to cart'
            },
            popupSettings: {
                width: {
                    mode: 'custom',
    ...
    mounted: function mounted() {
        // this.setPositions();
        this.addHandlers();
        if (this.itemType === 'popup' && !this.popupSettings.trigger.maxShowdelay.amount) {
            this.popupSettings.trigger.maxShowdelay = {
                amount: 30
            };
        }

        //if is woo add it to type list
        if (window.uicore_data.is_woo === true) {
            this.typeList.push('product info');
            this.blockHookList = [].concat(_toConsumableArray(this.blockHookList), [{ name: 'Before Product Summary', value: 'uicore__before_product_summary' }, { name: 'After Product Summary', value: 'uicore__after_product_summary' }, { name: 'Before Product Short Description', value: 'uicore__before_product_short_description' }, { name: 'After Product Short Description', value: 'uicore__after_product_short_description' }, { name: 'After Product Add to Cart Form', value: 'uicore__after_product_add_to_cart_form' }, { name: 'After Product Meta', value: 'uicore__after_product_meta' }, { name: 'After Product Share', value: 'uicore__after_product_share' }, { name: 'Before Product Related', value: 'uicore__before_product_related' }]);
            console.log(this.blockHookList);
        }
    },
    beforeDestroy: function beforeDestroy() {
        // console.log('done');
    ...
    methods: {
        ...
        addHandlers: function addHandlers() {
            ...
            jQuery('.row-actions .edit a, .page-title-action, body.post-type-uicore-tb a.row-title, body.post-type-uicore-tb a.page-title-action').on('click', function (s) {
                s.preventDefault();
                ...
                if (parent.length) {
                    ...
                    if (_this.itemType === 'product info') {
                        _this.rule.include = [{
                            rule: _this.getDefaultRule(),
                            specific: null
                        }];
                    }
                }
        ...
        setTitle: function setTitle() {
            ...
            if (url) {
                ...
                } else if (url === 'productinfo') {
                    this.itemType = 'product info';
                    this.mode = 'Product Info';
                } else {
                    this.itemType = url;
                }
            } else {
        ...
        save: function save(callback) {
            ...
            var item = {
                ...
                productSettings: this.productinfoSettings,
                blockHook: this.blockHook,
                enabled: this.enabled
            };
            this.showMessageName = !item.name;
            this.showMessageType = !item.type;
        ...
        getEdit: function getEdit() {
            ...
            axios.get(url).then(function (response) {
                if (response.data) {
                    var i = response.data;
                    var type = i.type == 'pagetitle' ? 'page title' : i.type;
                    type = type == 'megamenu' ? 'mega menu' : type;
                    type = type == 'productinfo' ? 'product info' : type;
                    type = i.type == 'pagetitle' ? 'page title' : type;
                    type = type == 'megamenu' ? 'mega menu' : type;
                    _this.enabled = i.enabled;
                    _this.itemId = i.id;
                    ...
                    _this.blockHook = i.blockHook;
                    if (i.type === 'popup') {
                        //check if maxShowdelay is not set
                        if (!i.popupSettings.trigger.hasOwnProperty("maxShowdelay")) {
                            i.popupSettings.trigger.maxShowdelay = {
                                amount: 30
                            };
                        }
                        _this.popupSettings = i.popupSettings;
                    } else if (i.type === 'productinfo') {
                        _this.productinfoSettings = i.productSettings;
                    }
                } else {
                    console.log(response);
                }
...
var render = function() {
  ...
  return _c("div", {
    domProps: {
      innerHTML: _vm._s(__webpack_require__(19)("./icon-" + this.icon + ".svg"))
    },
    on: {
...
exports.default = {
    ...
    methods: {
        getSearch: function getSearch(e) {
            ...
            axios.post(url, { term: e, type: this.type }).then(function (response) {
                if (response.data) {
                    console.log(response.data);
...
var map = {
	"./icon-admin-customizer.svg": 20,
	"./icon-animations.svg": 21,
	"./icon-blog.svg": 22,
	"./icon-branding.svg": 23,
	"./icon-buttons.svg": 24,
	"./icon-close.svg": 25,
	"./icon-custom.svg": 26,
	"./icon-dark-mode.svg": 27,
	"./icon-dashboard.svg": 28,
	"./icon-debug.svg": 29,
	"./icon-demo-loader.svg": 30,
	"./icon-desktop.svg": 31,
	"./icon-documentation.svg": 32,
	"./icon-edit.svg": 33,
	"./icon-feedback.svg": 34,
	"./icon-footer.svg": 35,
	"./icon-general.svg": 36,
	"./icon-global-colors.svg": 37,
	"./icon-global-fonts.svg": 38,
	"./icon-global.svg": 39,
	"./icon-header.svg": 40,
	"./icon-import-preset.svg": 41,
	"./icon-import.svg": 42,
	"./icon-light-mode.svg": 43,
	"./icon-page-title.svg": 44,
	"./icon-performance.svg": 45,
	"./icon-phone.svg": 46,
	"./icon-plugins.svg": 47,
	"./icon-portfolio.svg": 48,
	"./icon-preset.svg": 49,
	"./icon-presetm.svg": 50,
	"./icon-remove-preset.svg": 51,
	"./icon-search.svg": 52,
	"./icon-social.svg": 53,
	"./icon-success.svg": 54,
	"./icon-system.svg": 55,
	"./icon-tablet.svg": 56,
	"./icon-theme-skin.svg": 57,
	"./icon-top-banner.svg": 58,
	"./icon-typography.svg": 59,
	"./icon-updates.svg": 60,
	"./icon-warning.svg": 61,
	"./icon-woo.svg": 62
};
...
var _ThemeBuilder = __webpack_require__(449);
...
var _vue2PerfectScrollbar = __webpack_require__(71);

var _vue2PerfectScrollbar2 = _interopRequireDefault(_vue2PerfectScrollbar);

var _uicoreMultiselect = __webpack_require__(455);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_ThemeBuilder_vue__ = __webpack_require__(179);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_57cbf9ba_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_ThemeBuilder_vue__ = __webpack_require__(454);
var disposed = false
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_rule_vue__ = __webpack_require__(180);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_396a6726_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_rule_vue__ = __webpack_require__(453);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
        ...
        ? _c(
            ...
            [
              ...
              _c("div", [
                      ...
                      _c(
                        ...
                        [
                          ...
                          _vm.showMessageType
                            ? _c(
                                "span",
                                { staticClass: "uicore_p uicore-red-text" },
                ...
                _vm._v(" "),
                _c("div", { staticClass: "uicore-core-setting uicore-sub" }, [
                  _c("span", { staticClass: "uicore_text" }, [
                    _c("span", { staticClass: "uicore_h2" }, [
                      _vm._v("Item Status")
                    ]),
                    _vm._v(" "),
                    _c("span", { staticClass: "uicore_p" }, [
                      _vm._v("Activate (publish) / deactivate (draft) ")
                    ])
                  ]),
                  _vm._v(" "),
                  _c(
                ...
                _c(
                    ...
                    directives: [
                      {
                        name: "show",
                        rawName: "v-show",
                        value: _vm.itemType === "block",
                        expression: "itemType === 'block'"
                      }
                    ],
                    staticClass: "uicore-core-setting"
                  },
                  [
                    _c("span", { staticClass: "uicore_text" }, [
                      ...
                      _vm._v(" "),
                      _c("span", { staticClass: "uicore_p" }, [
                        _vm._v("Choose the block position on page.")
                      ])
                    ]),
                    _vm._v(" "),
                    _c(
                      ...
                      [
                        _c("multiselect", {
                          staticClass: "uicore-l",
                          attrs: {
                            id: "ui-bn65-sel",
                            options: _vm.blockHookList,
                            "allow-empty": false,
                            "show-labels": false,
                            searchable: true,
                            "track-by": "name",
                          ...
                          on: {
                            select: function($event) {
                              return _vm.emitP(_vm.blockHook)
                            }
                          },
                          scopedSlots: _vm._u(
                            [
                    ...
                    directives: [
                      {
                        name: "show",
                        rawName: "v-show",
                        value: _vm.itemType === "product info",
                        expression: "itemType === 'product info'"
                      }
                    ]
                  },
                  [
                    _c("div", { staticClass: "uicore-core-setting" }, [
                      _c("span", { staticClass: "uicore_text" }, [
                        _c("span", { staticClass: "uicore_h2" }, [
                          _vm._v("Display Info as")
                        ]),
                        _vm._v(" "),
                        _c("span", { staticClass: "uicore_p" }, [
                          _vm._v(
                            "Set how you want to add the informations on products."
                          )
                        ])
                      ]),
                      _vm._v(" "),
                      _c(
                        ...
                        [
                          _c("multiselect", {
                            ...
                            attrs: {
                              id: "ui-113d-sel",
                              options: _vm.productinfoDisplayList,
                              "allow-empty": false,
                              "show-labels": false,
                              searchable: false,
                              "allow-custom": true,
                            ...
                            model: {
                              value: _vm.productinfoSettings.display,
                              callback: function($$v) {
                                _vm.$set(
                                  _vm.productinfoSettings,
                                  "display",
                                  $$v
                                )
                              },
                              expression: "productinfoSettings.display"
                            }
                          })
                        ],
                        1
                    ...
                    _c("div", { staticClass: "uicore-core-setting" }, [
                      _c("span", { staticClass: "uicore_text" }, [
                        _c("span", { staticClass: "uicore_h2" }, [
                          _vm._v(
                            _vm._s(
                              _vm.productinfoSettings.display === "tab"
                                ? "Tab"
                                : "Popup Trigger"
                            ) + " Label"
                          )
                        ...
                        _c("span", { staticClass: "uicore_p" }, [
                          _vm._v(
                            "Set the name that will be used as trigger label."
                          )
                        ])
                      ]),
                      _vm._v(" "),
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.productinfoSettings.label,
                              expression: "productinfoSettings.label"
                            }
                          ],
                          staticClass: "uicore_l",
                          attrs: { name: "bw" },
                          domProps: { value: _vm.productinfoSettings.label },
                          on: {
                            input: function($event) {
                              if ($event.target.composing) {
                                return
                    ...
                    _c(
                        ...
                        directives: [
                          {
                            name: "show",
                            rawName: "v-show",
                            value: _vm.productinfoSettings.display === "tab",
                            expression: "productinfoSettings.display === 'tab'"
                          }
                        ],
                      ...
                      [
                        _c("span", { staticClass: "uicore_text" }, [
                          ...
                          _c("span", { staticClass: "uicore_p" }, [
                            _vm._v(
                              "Default tabs have a priority from with a 10 gap."
                            )
                          ])
                        ]),
                        _vm._v(" "),
                        _c("span", { staticClass: "uicore_set" }, [
                          _c("div", { staticClass: "ui-switch-sub" }, [
                                ...
                                directives: [
                                  {
                                    name: "model",
                                    rawName: "v-model",
                                    value: _vm.productinfoSettings.order,
                                    expression: "productinfoSettings.order"
                                  }
                                ],
                                staticClass: "uicore_m",
                                attrs: { min: -1000, max: 1500, step: 1 },
                                domProps: {
                                  value: _vm.productinfoSettings.order
                                },
                                on: {
                            ...
                            _c("small", [
                              _vm._v(
                                "Description 10 / Additional Information 20 / Reviews 30"
                              )
                            ])
                          ])
                        ])
                    ...
                    _c(
                        ...
                        directives: [
                          {
                            name: "show",
                            rawName: "v-show",
                            value: _vm.productinfoSettings.display === "popup",
                            expression:
                              "productinfoSettings.display === 'popup'"
                          }
                        ],
                        staticClass: "uicore-core-setting uicore-sub"
                      },
                      [
                        _c("span", { staticClass: "uicore_text" }, [
                          _c("span", { staticClass: "uicore_h2" }, [
                            _vm._v("Trigger Placement")
                          ]),
                          _vm._v(" "),
                          _c("span", { staticClass: "uicore_p" }, [
                            _vm._v(
                              "Chose where you want to display the popup trigger"
                            )
                          ])
                        ]),
                        _vm._v(" "),
                          ...
                          _c(
                            ...
                            [
                              _c("multiselect", {
                                ...
                                model: {
                                  value: _vm.productinfoSettings.popupTrigger,
                                  callback: function($$v) {
                                    _vm.$set(
                                      _vm.productinfoSettings,
                                      "popupTrigger",
                                  ...
                                  expression: "productinfoSettings.popupTrigger"
                                }
                              })
                            ],
                            1
                    ...
                    directives: [
                      {
                        ...
                        value:
                          _vm.itemType === "popup" ||
                          _vm.productinfoSettings.display === "popup",
                        expression:
                          "itemType === 'popup' || productinfoSettings.display === 'popup'"
                      }
                    ],
                  ...
                  [
                    ...
                    _c(
                      ...
                      [
                        _c("span", { staticClass: "uicore_text" }, [
                          _c("span", { staticClass: "uicore_h2" }, [
                            _vm._v("Close On Element Click")
                          ]),
                          _vm._v(" "),
                          _c("span", { staticClass: "uicore_p" }, [
                            _vm._v("Close when certain element is clicked.")
                          ])
                        ]),
                        _vm._v(" "),
                        _c("span", { staticClass: "uicore_set" }, [
                                ...
                                directives: [
                                  {
                                    name: "model",
                                    rawName: "v-model",
                                    value: _vm.popupSettings.closeOnElement,
                                    expression: "popupSettings.closeOnElement"
                                  }
                                ],
                                staticClass: "uicore_m",
                    ...
                    directives: [
                      {
                        ...
                        value:
                          ...
                          _vm.itemType != "",
                        expression:
                          "itemType != 'mega menu' && (itemType != 'block' || itemType == 'block' &&  blockHook.value != 'custom' ) && itemType != ''"
                      }
                    ],
                    staticClass:
                      ...
                      [
                        ...
                        _c(
                          "span",
                          {
                            ...
                            on: {
                              click: function($event) {
                                _vm.rule.include.push({
                                  rule: _vm.getDefaultRule(),
                                  specific: null
                                })
                              }
                            }
                ...
                _vm._v(" "),
                _vm.itemType != "mega menu" && _vm.itemType != "product info"
                  ? _c(
                      "div",
                      { staticClass: "uicore-core-setting uicore-sub" },
                      [
                              ...
                              ? _c("div", { staticClass: "ui-switch-sub" }, [
                                        ...
                                        directives: [
                                          {
                                            ...
                                            value:
                                              _vm.popupSettings.trigger
                                                .maxShowdelay.amount,
                                            expression:
                                              "popupSettings.trigger.maxShowdelay.amount"
                                          }
                                        ],
                                        staticClass: "uicore_s",
                                        attrs: { min: 1, max: 1500, step: 1 },
                                  ...
                                  _c("small", [
                                    _vm._v(
                                      "Reset every " +
                                        _vm._s(
                                          _vm.popupSettings.trigger.maxShowdelay
                                            .amount
                                        ) +
                                        " day(s)"
                                    )
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_uicoreMultiselect_vue__ = __webpack_require__(181);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_3acb0aa1_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_uicoreMultiselect_vue__ = __webpack_require__(456);
var disposed = false
var normalizeComponent = __webpack_require__(0)
/* script */
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_SvgIcon_vue__ = __webpack_require__(12);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_bd6236d4_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_SvgIcon_vue__ = __webpack_require__(18);
var disposed = false
var normalizeComponent = __webpack_require__(0)
/* script */
    ...
    [
      !_vm.mini
        ? _c(
            "div",
            {
              staticClass: "uicore-type uicore-solid uicore-base_input",
              on: {
                click: function($event) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_uicore_mini_toggle_vue__ = __webpack_require__(14);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_33203615_hasScoped_true_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_uicore_mini_toggle_vue__ = __webpack_require__(64);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_Popup_vue__ = __webpack_require__(17);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_de6b95f6_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_Popup_vue__ = __webpack_require__(74);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
