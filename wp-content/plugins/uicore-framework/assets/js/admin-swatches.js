...
exports.default = {
    ...
    methods: {
        ...
        setColor: function setColor() {
            ...
            this.previewEl.css('--ui-swatches-bg', this.value);
        },
        addHandlers: function addHandlers() {
            var type = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "";

            this.el = type == 'second' ? jQuery('#uicore_second_color') : jQuery('#uicore_color');
            this.previewEl = type == 'second' ? jQuery('#uicore_second_color_preview') : jQuery('#uicore_color_preview');

            var oldVal = this.el.val();
            this.value = oldVal ? oldVal : '#fff';
...
var _colorPicker = __webpack_require__(465);
...
// import Picker from './iconPicker.vue';


jQuery(document).ready(function ($) {

    $('body').append("<div id='uicore-colorPicker'></div>");
    ...
    //toggle fields visibility based on #uicore_swatch_select value
    // Now fields are printed dinamically based on parent attribute swatch
    /*
    const toggleFields = function(value){
        if(value == 'bicolor'){
            $('.uicore-field').hide();
            $('.term-uicore-color-wrap, .term-uicore-second-color-wrap').show();
        }else{
            $('.uicore-field').hide();
            $('.term-uicore-'+value+'-wrap').show();
        }
    }
    */

    // var swatch_select = $('#uicore_swatch_select');
    // var swatch_select_val = swatch_select.val();


    //initial run
    // toggleFields(swatch_select_val);

    //run on change
    // swatch_select.on('change', function(){
...
window.uicore_set_image = function () {
    ...
    file_frame.on('select', function () {
        ...
        console.log('url(' + attachment.url + ') no-repeat center center/cover;');
        jQuery('#uicore_image_preview').css('--ui-swatches-bg', 'url(' + attachment.url + ') no-repeat center center/cover').parent('td').addClass('uicore-is-set');
        jQuery('#uicore_image').val(attachment.url);
...
window.uicore_remove_image = function () {
    jQuery('#uicore_image').val('');
    jQuery('#uicore_image_preview').css('--ui-swatches-bg', 'initial').parent('td').removeClass('uicore-is-set');
};
window.uicore_remove_color = function () {
    jQuery('#uicore_second_color').val('');
    jQuery('#uicore_second_color_preview').css('--ui-swatches-bg', 'transparent');
};
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_colorPicker_vue__ = __webpack_require__(184);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_f5096a3a_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_colorPicker_vue__ = __webpack_require__(467);
var disposed = false
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_f5096a3a_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_colorPicker_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "assets/src/admin-swatches/colorPicker.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-f5096a3a", Component.options)
  } else {
    hotAPI.reload("data-v-f5096a3a", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c(
    ...
    [
      _vm.show
        ? _c("color", {
            attrs: { background: _vm.value, isglobal: true, mini: true },
            on: {
              set: function($event) {
                return _vm.close()
              }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-f5096a3a", esExports)
  }
}
