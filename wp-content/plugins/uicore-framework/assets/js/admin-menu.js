...
exports.default = {
    ...
    data: function data() {
        return {
            id: null,
            show: false,
            icons: uicore_data.icons
        };
    },
    mounted: function mounted() {
        window.uicore_set_icon = this.addHandlers;
    },
    ...
    methods: {
        ...
        setIcon: function setIcon(name, path) {
            jQuery('[data-menuid="' + this.id + '"].ui-icon svg').remove();
            jQuery('[data-menuid="' + this.id + '"].ui-icon').prepend(path);
            jQuery('[data-menuid="' + this.id + '"].ui-icon').parent('.ui-menu-section').addClass('uicore-is-set');
            jQuery('[name="menu-item-icon[' + this.id + ']"]').val(name);
            this.close();
        },
        addHandlers: function addHandlers(el) {
            var id = jQuery(el).data('menuid');
            this.id = id;
            this.show = true;
        }
    }
...
exports.default = {
    ...
    mounted: function mounted() {
        window.uicore_set_color = this.addHandlers;
    },
    ...
    methods: {
        ...
        setColor: function setColor() {
            jQuery('.ui-' + this.type + '-color-preview.item-color-prev-' + this.id + '').css('--ui-' + this.type + '-color', this.getColorCode());
            jQuery('[name="menu-item-' + this.type + '-color[' + this.id + ']"]').val(this.value);
        },
        getColorCode: function getColorCode() {
            var value = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;

            var color = value ? value : this.value;
            if (color == 'Primary') {
                color = this.uicoreSettings.pColor + '';
            } else if (color == 'Secondary') {
                color = this.uicoreSettings.sColor + '';
                ...
                color = this.getColorCode(this.uicoreSettings.mmenu_typo.c + '');
            }
            return color;
        },
        addHandlers: function addHandlers(el) {
            var type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "badge";

            var id = jQuery(el).data('menuid');
            this.id = id;
            this.type = type;
            this.inheritValue = type === 'badge' ? false : this.uicoreSettings.mmenu_typo.c + '';
            var devaultValue = type === 'badge' ? 'Primary' : 'Inherit';

            var oldVal = jQuery('[name="menu-item-' + this.type + '-color[' + id + ']"]').val();
            this.value = oldVal ? oldVal : devaultValue;
...
var _iconPicker = __webpack_require__(424);

var _iconPicker2 = _interopRequireDefault(_iconPicker);

var _colorPicker = __webpack_require__(427);
...
jQuery(document).ready(function ($) {
    ...
    $('.menu-settings').append("<div id='uicore-iconPicker'></div>");
    $('.menu-settings').append("<div id='uicore-colorPicker'></div>");

    new _vue2.default({
        el: '#uicore-iconPicker',
        render: function render(h) {
            return h(_iconPicker2.default);
        }
    });

    new _vue2.default({
        el: '#uicore-colorPicker',
        store: _store2.default,
        render: function render(h) {
            return h(_colorPicker2.default);
        }
    });
});

window.uicore_mega_type = function (el) {
    var id = jQuery(el).data('menuid');
    if (jQuery(el).is(":checked") === true) {
        console.log('daaaa');
        jQuery('[name="menu-item-mega-type[' + id + ']"]').show();
    } else {
        jQuery('[name="menu-item-mega-type[' + id + ']"]').hide();
    }
};

function hasBadgeText(el) {
...
// in Vue / ColorPicker
// window.uicore_set_color
window.uicore_badge_input = function (el) {
    jQuery(el).parent('.ui-menu-section').toggleClass('uicore-is-set', hasBadgeText(jQuery(el)));
};
window.uicore_remove_badge = function (el) {
    var id = jQuery(el).data('menuid');
    jQuery('[name="menu-item-badge[' + id + ']"]').val('').trigger('input');
};

// in Vue / IconPicker
// window.uicore_set_icon
window.uicore_remove_icon = function (el) {
    var id = jQuery(el).data('menuid');
    jQuery('[name="menu-item-icon[' + id + ']"]').val('');
    jQuery('[data-menuid="' + id + '"].ui-icon').parent('.ui-menu-section').removeClass('uicore-is-set');
};

// Uploading files
var file_frame;

window.uicore_set_image = function (el) {
    var menuid = jQuery(el).data("menuid");

    // If the media frame already exists, reopen it.
    if (file_frame) {
        // Set the post ID to what we want
        file_frame.uploader.uploader.param('post_id', menuid);
        // Open frame
        file_frame.open();
        return;
    } else {
        // Set the wp.media post id so the uploader grabs the ID we want when initialised
        wp.media.model.settings.post.id = menuid;
    }
    ...
    file_frame.on('select', function () {
        ...
        jQuery('.image-preview-' + menuid).attr('src', attachment.url).parent().parent('.ui-menu-section').addClass('uicore-is-set');
        jQuery('[name="menu-item-img[' + menuid + ']"]').val(attachment.id);
...
window.uicore_remove_image = function (el) {
    var id = jQuery(el).data('menuid');
    jQuery('[name="menu-item-img[' + id + ']"]').val('');
    jQuery('.image-preview-' + id).attr('src', '').parent().parent('.ui-menu-section').removeClass('uicore-is-set');
};
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_iconPicker_vue__ = __webpack_require__(170);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_iconPicker_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_iconPicker_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_iconPicker_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_iconPicker_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_63e293b0_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_iconPicker_vue__ = __webpack_require__(426);
var disposed = false
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_iconPicker_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_63e293b0_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_iconPicker_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "assets/src/admin-menu/iconPicker.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-63e293b0", Component.options)
  } else {
    hotAPI.reload("data-v-63e293b0", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
var render = function() {
  ...
  return _c(
    "div",
    {
      staticClass: "uicore_dark_scheme uicore_icons",
      staticStyle: { "--uicore-primary": "#532df5" }
    },
    [
      _vm.show
        ? _c(
            "popup",
            {
              attrs: {
                title: "Select a Icon",
                btn1: { text: "Cancel", class: "uicore-red" }
              },
              on: {
            ...
            [
              _c(
                "div",
                { staticClass: "uicore-icons-grid" },
                _vm._l(_vm.icons, function(path, name) {
                  return _c("div", {
                    staticClass: "uicore-icon-wrapp",
                    domProps: { innerHTML: _vm._s(path) },
                    on: {
                      click: function($event) {
                        return _vm.setIcon(name, path)
                      }
                    }
                  })
                }),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-63e293b0", esExports)
  }
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_colorPicker_vue__ = __webpack_require__(171);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_colorPicker_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_colorPicker_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_colorPicker_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_colorPicker_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_20723bd8_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_colorPicker_vue__ = __webpack_require__(429);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_colorPicker_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_20723bd8_hasScoped_false_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_colorPicker_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "assets/src/admin-menu/colorPicker.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-20723bd8", Component.options)
  } else {
    hotAPI.reload("data-v-20723bd8", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-20723bd8", esExports)
  }
}
