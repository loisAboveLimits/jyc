...
class Image_Expand extends Module_Base {
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[ 
				...
				'options'              => [ 
					'default'     => esc_html__( 'Horizontal', 'bdthemes-element-pack' ),
					'vertical'    => esc_html__( 'Vertical', 'bdthemes-element-pack' ),
					'sliding-box' => esc_html__( 'Sliding Box', 'bdthemes-element-pack' ),
				],
				'default'              => 'default',
		...
		$this->add_control(
			...
			[ 
				...
				'default'     => [ 
					[ 
						'image_expand_sub_title' => esc_html__( 'This is a label', 'bdthemes-element-pack' ),
						'image_expand_title'     => esc_html__( 'Image Expand Item One', 'bdthemes-element-pack' ),
						'image_expand_text'      => esc_html__( 'Lorem ipsum dolor sit amet consect voluptate repell endus kilo gram magni.', 'bdthemes-element-pack' ),
						'slide_image'            => [ 'url' => BDTEP_ASSETS_URL . 'images/gallery/item-1.svg' ]
					],
					[ 
						'image_expand_sub_title' => esc_html__( 'This is a label', 'bdthemes-element-pack' ),
						'image_expand_title'     => esc_html__( 'Image Expand Item Two', 'bdthemes-element-pack' ),
						'image_expand_text'      => esc_html__( 'Lorem ipsum dolor sit amet consect voluptate repell endus kilo gram magni.', 'bdthemes-element-pack' ),
						'slide_image'            => [ 'url' => BDTEP_ASSETS_URL . 'images/gallery/item-2.svg' ]
					],
					[ 
						'image_expand_sub_title' => esc_html__( 'This is a label', 'bdthemes-element-pack' ),
						'image_expand_title'     => esc_html__( 'Image Expand Item Three', 'bdthemes-element-pack' ),
						'image_expand_text'      => esc_html__( 'Lorem ipsum dolor sit amet consect voluptate repell endus kilo gram magni.', 'bdthemes-element-pack' ),
						'slide_image'            => [ 'url' => BDTEP_ASSETS_URL . 'images/gallery/item-3.svg' ]
					],
					[ 
						'image_expand_sub_title' => esc_html__( 'This is a label', 'bdthemes-element-pack' ),
						'image_expand_title'     => esc_html__( 'Image Expand Item Four', 'bdthemes-element-pack' ),
						'image_expand_text'      => esc_html__( 'Lorem ipsum dolor sit amet consect voluptate repell endus kilo gram magni.', 'bdthemes-element-pack' ),
		...
		$this->add_responsive_control(
			...
			[ 
				'label'     => esc_html__( 'Vertical Alignment', 'bdthemes-element-pack' ) . BDTEP_NC,
				'type'      => Controls_Manager::CHOOSE,
				'options'   => [ 
					'flex-start' => [ 
		...
		$this->add_control(
			'animation_of',
			[ 
				'label'     => esc_html__( 'Animation Of', 'bdthemes-element-pack' ),
				'type'      => Controls_Manager::SELECT2,
				'multiple'  => true,
				'options'   => [ 
					'.bdt-ep-image-expand-sub-title' => esc_html__( 'Sub Title', 'bdthemes-element-pack' ),
					'.bdt-ep-image-expand-title'     => esc_html__( 'Title', 'bdthemes-element-pack' ),
					'.bdt-ep-image-expand-text'      => esc_html__( 'Text', 'bdthemes-element-pack' ),
				],
		...
		$this->start_controls_section(
			...
			[ 
				'label' => esc_html__( 'Image Expand Item', 'bdthemes-element-pack' ),
	...
	public function render_lightbox( $item ) {
		...
		$this->add_render_attribute( 'lightbox', 'data-caption', wp_kses( $item['image_expand_title'], element_pack_allow_tags( 'title' ) ), true );
		...
		<div class="bdt-ie-lightbox-wrap">
			<a <?php $this->print_render_attribute_string( 'lightbox' ); ?>>
				...
				<?php elseif ( 'text' == $settings['link_type'] ) : ?>
					<span class="bdt-text">
						<?php esc_html_e( 'ZOOM', 'bdthemes-element-pack' ); ?>
					</span>
				<?php endif; ?>
			</a>
		</div>
		...
		<div class="bdt-ep-image-expand-content">
			...
			<?php if ( $item['image_expand_title'] && ( 'yes' == $settings['show_title'] ) ) : ?>
				<<?php echo esc_attr( Utils::get_valid_html_tag( $settings['title_tags'] ) ); ?>
					<?php $this->print_render_attribute_string( 'bdt-ep-image-expand-title' ); ?>>
			...
			<?php if ( $item['image_expand_text'] && ( 'yes' == $settings['show_text'] ) ) : ?>
				<div class="bdt-ep-image-expand-text <?php echo esc_attr( $text_hide_on_setup ); ?>">
					<?php echo wp_kses_post( $this->parse_text_editor( $item['image_expand_text'] ) ); ?>
				</div>
			<?php endif; ?>
	...
	public function render_image( $item ) {
		...
		<div class="bdt-ep-image-expand-img">
			...
			if ( ! $thumb_url ) {
				printf( '<img src="%1$s" alt="%2$s">', esc_url( $item['slide_image']['url'] ), esc_html( $item['image_expand_title'] ) );
			} else {
	...
	public function render() {
		...
		<div <?php $this->print_render_attribute_string( 'image-expand' ); ?>>
			<?php foreach ( $settings['image_expand_items'] as $index => $item ) :
				...
				<?php if ( $settings['skin_type'] !== 'sliding-box' ) : ?>
					<div <?php $this->print_render_attribute_string( 'image-expand-item' ); ?>
