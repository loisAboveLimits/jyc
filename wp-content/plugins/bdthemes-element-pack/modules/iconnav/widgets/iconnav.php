...
class Iconnav extends Module_Base {
	...
	public function render_loop_iconnav_list( $list, $element_key ) {
		...
		?>
		<li <?php $this->print_render_attribute_string( 'iconnav-item' ); ?>>
			<a <?php $this->print_render_attribute_string( $element_key ); ?> 		<?php echo esc_url( $scroll_active ); ?>>
				...
				<?php if ( 'show_under_icon' == $settings['menu_text'] ) : ?>
					<span class="bdt-menu-text bdt-display-block bdt-text-small">
						<?php echo esc_html( $list["iconnav_title"] ); ?>
					</span>
				<?php endif; ?>
			</a>
		</li>
	...
	protected function render() {
		...
		?>
		<div <?php $this->print_render_attribute_string( 'icon-nav' ); ?>>
			<div <?php $this->print_render_attribute_string( 'nav-container' ); ?>>
				<div class="bdt-icon-nav-branding">
					<?php if ( $settings['show_branding'] ) : ?>
						<?php if ( ! empty( $settings['branding_image']['url'] ) ) : ?>
							<div class="bdt-logo-image"><img src="<?php echo esc_url( $settings['branding_image']['url'] ); ?>"
									alt="<?php echo esc_url( get_bloginfo( 'name' ) ); ?>"></div>
						<?php else : ?>
							<?php
					...
					<?php if ( $settings['navbar'] ) : ?>
						<li>
							<a class="bdt-icon-nav-icon-wrapper" href="#"
								data-bdt-toggle="target: #bdt-offcanvas<?php echo esc_attr( $id ); ?>">
								<span class="bdt-icon-nav-icon">
	...
	private function offcanvas( $settings ) {
		...
		?>
		<div <?php $this->print_render_attribute_string( 'offcanvas-settings' ); ?>>
