...
?>
        <a href="<?php echo esc_url(get_the_permalink()); ?>" <?php echo esc_attr($target); ?>>
                    ...
                    if ('none' !== $settings['show_link']) : ?>
                        <div class="bdt-flex-inline bdt-gallery-item-link-wrapper">
                            ...
                            <?php if (('post' == $settings['show_link']) || ('both' == $settings['show_link'])) : ?>
                                ...
                                ?>
                                <a class="bdt-gallery-item-link<?php echo esc_attr($link_type_class); ?>" href="<?php echo esc_attr(get_permalink()); ?>" target="<?php echo esc_attr($target); ?>">
                                    <?php if ('icon' == $settings['link_type']) : ?>
