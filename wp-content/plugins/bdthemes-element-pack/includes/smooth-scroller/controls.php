...
class Settings_Contorls extends Tab_Base {
    ...
    //     );
        // $this->add_control(
        //     'smooth_scroller_selector',
        //     [
        //         'label'         => esc_html__('Selector (If you have sticky element)', 'bdthemes-element-pack'),
        //         'type'          => Controls_Manager::TEXT,
        //         'placeholder'       => '#my-id',
        //         'dynamic'       => ['active' => true],
        //         'description'       => esc_html__('Type here sticky element class or ID with comma(,) separated here. Ex- #my-id or .my-class,.my-class', 'bdthemes-element-pack'),
        //     ]
        // );
