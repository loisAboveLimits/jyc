...
class TheTitle extends Widget_Base
{
    ...
    {
        return esc_html__('The Title', 'uicore-elements');
    }
    ...
    {
        return 'eicon-t-letter ui-e-widget';
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            'view',
            [
                'label' => esc_html__('View', 'uicore-elements'),
...
\Elementor\Plugin::instance()->widgets_manager->register(new TheTitle());
